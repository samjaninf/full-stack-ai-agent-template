...
**ai_agent_teams_2** - FastAPI application generated with [Full-Stack AI Agent Template](https://github.com/vstorm-co/full-stack-ai-agent-template).
...
# RAG
uv run ai_agent_teams_2 rag-collections
uv run ai_agent_teams_2 rag-ingest /path/to/file.pdf --collection docs
uv run ai_agent_teams_2 rag-search "query" --collection docs
uv run ai_agent_teams_2 rag-sync-gdrive --collection docs
uv run ai_agent_teams_2 rag-sync-s3 --collection docs

# Sync Sources
uv run ai_agent_teams_2 cmd rag-sources
uv run ai_agent_teams_2 cmd rag-source-add
uv run ai_agent_teams_2 cmd rag-source-sync
```
