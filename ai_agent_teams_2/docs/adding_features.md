...
Run with: `uv run ai_agent_teams_2 cmd my-command --name test`
...
# Or use CLI
uv run ai_agent_teams_2 db migrate -m "Add notifications table"
uv run ai_agent_teams_2 db upgrade
```
