...
|----------|---------|-------------|
| `PROJECT_NAME` | `ai_agent_teams_2` | Display name for the project |
...
| `POSTGRES_DB` | `ai_agent_teams_2` | Database name |
...
| `LOGFIRE_SERVICE_NAME` | `ai_agent_teams_2` | Service name in Logfire dashboard |
...
| `S3_RAG_BUCKET` | `ai_agent_teams_2-rag` | Bucket name |
